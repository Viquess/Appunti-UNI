...
\renewcommand{\headrule}{%
  \ifthenelse{\equal{\rightmark}{}}{}{%
    {\color{lightgray}\hrule width\headwidth height\headrulewidth \vskip-\headrulewidth}%
  }%
}
\renewcommand{\footrulewidth}{0.2pt}
\renewcommand{\footrule}{{\color{lightgray}\hrule width\headwidth height\footrulewidth \vskip-\footrulewidth}}
\fancyhead[R]{\rightmark}
\fancyfoot[L]{Capitolo \leftmark} 
\fancyfoot[R]{\thepage}
...
\sloppy
\graphicspath{{images/}}
\setlist{itemsep=0.5pt, topsep = 6pt}
\setlist[enumerate,1]{label=\textbf{\arabic*.}}
\definecolor{definition}{RGB}{180,230,180}
\definecolor{theorem}{RGB}{255,150,150}
...
\newtcolorbox{theorem}[1][]{
  statement,
  colframe=theorem,
  boxed title style={colback=theorem},
  before title={\refstepcounter{theorem}},
  title={Teorema \thetheorem: #1}
}
